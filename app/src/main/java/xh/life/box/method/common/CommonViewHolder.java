...
public class CommonViewHolder {
    ...
    public CommonViewHolder setGImage(int vid, String url) {
        ...
        Glide.with(mContext).load(url).error(R.drawable.blue_borde_normal).into(img);
        return this;
    }
    ...
    public CommonViewHolder setGlideImage(int vid, String url) {
        ImageView img = getView(vid);
        GlideImgManager.glideLoader(mContext, url, R.drawable.blue_borde_normal, R.drawable.blue_borde_normal, img, 0);
        return this;
    }
    ...
    public CommonViewHolder setRoundImage(int vid, String url) {
        ImageView img = getView(vid);
        GlideImgManager.glideLoader(mContext, url, R.drawable.blue_borde_normal, R.drawable.blue_borde_normal, img, 1);
        return this;
    }
